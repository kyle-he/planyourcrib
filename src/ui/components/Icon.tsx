...
const PATHS = {
  ...
  github: (
    <>
      <path d="M15 21v-3.9a3.4 3.4 0 00-.9-2.6c3 0 6.1-1.5 6.1-6.7A5.2 5.2 0 0018.8 4a4.9 4.9 0 00-.1-3.8S17.6-.2 15 1.7a13.4 13.4 0 00-6 0C6.4-.2 5.3.2 5.3.2A4.9 4.9 0 005.2 4a5.2 5.2 0 00-1.4 3.8c0 5.2 3.1 6.7 6.1 6.7a3.4 3.4 0 00-.9 2.6V21" />
