...
const TOOL_HINTS: Record<string, string> = {
  ...
  wall: 'Drag to draw · Endpoints attach nearby walls · Attached walls snap perpendicular',
...
export function StatusBar() {
  ...
  const count = selection.rooms.length + selection.walls.length + selection.items.length + selection.openings.length
